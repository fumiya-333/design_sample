...
if(wp_is_mobile()){
  $company_contents_titles = array("サイトのゴール = ", "夢を叶えること");
...
<div class="company-contents">
  <div class="company-message-box">
    <div class="company-message">
      ...
      <div class="company-message-title-box">
        <?php
          foreach($company_contents_titles as $company_contents_title){
            echo '<div class="company-message-title">' . $company_contents_title . '</div>';
          }
        ?>
      </div>
